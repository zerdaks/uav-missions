...
has_precondition(hover_action_2, hover_action_3).
...
?- singleton_subject(hover_action_3).
?- singleton_subject(hover_action_4).
...
?- primary_asset(ardrone_1).
?- primary_asset(hummingbird_1). % false
