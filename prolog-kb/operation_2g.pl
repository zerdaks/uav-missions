...
?- constrained_subject(hover_action_1).
...
?- leading_subject(hover_action_1).
...
?- subject_constraint(hover_action_2).
?- subject_constraint(hover_action_3).
...
?- terminal_subject_constraint(hover_action_3).
