...
has_action(hummingbird_3, hover_action_5).
...
has_precondition(hover_action_4, hover_action_5).
...
?- singleton_subject(hover_action_5).
...
?- terminal_subject(hover_action_4).
...
?- terminal_observer(hover_action_4).
...
?- observer_and_terminal_subject(hover_action_4).
