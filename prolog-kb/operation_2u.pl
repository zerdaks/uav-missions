...
?- check_default_terminal(hover_action_3).
...
?- check_subject_precondition(hover_action_4).
...
?- check_constrained_subject(hover_action_4). % false
...
?- check_terminal_observer(hover_action_5).
...
?- check_observer_and_terminal_subject(hover_action_5).
...
?- check_subject_constraint(hover_action_5). % false
