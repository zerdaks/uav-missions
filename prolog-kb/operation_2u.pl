...
has_precondition(hover_action_2, hover_action_5).
has_precondition(hover_action_3, hover_action_2).
has_precondition(hover_action_5, hover_action_4).
has_precondition(hover_action_5, hover_action_6).
...
?- default_terminal(hover_action_3).
...
?- constrained_subject(hover_action_4). % false
...
?- singleton_subject(hover_action_6).
...
?- terminal_subject(hover_action_5).
...
?- default_observer(hover_action_5).
...
?- terminal_observer(hover_action_5).
...
?- observer_and_terminal_subject(hover_action_5).
...
?- subject_constraint(hover_action_5). % false
?- subject_constraint(hover_action_6). % false
...
?- terminal_subject_constraint(hover_action_6). % false
