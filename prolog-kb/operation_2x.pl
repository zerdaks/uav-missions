...
has_action(hummingbird_3, hover_action_7).
...
has_precondition(hover_action_6, hover_action_7).

?- print_heading('operation_2x').
...
?- check_default(hover_action_7). % false
...
?- check_default_singleton(hover_action_7). % false
...
?- check_default_terminal(hover_action_7). % false
...
?- check_subject_precondition(hover_action_7). % false
...
?- check_observer_precondition(hover_action_4).
?- check_observer_precondition(hover_action_5).
?- check_observer_precondition(hover_action_6). % false
?- check_observer_precondition(hover_action_7). % false
...
?- check_constrained_subject(hover_action_7). % false
...
?- check_leading_subject(hover_action_7). % false
...
?- check_singleton_subject(hover_action_6). % false
?- check_singleton_subject(hover_action_7).
...
?- terminal_subject(hover_action_7). % false

?- print_heading('c10 default_observer').
?- default_observer(hover_action_1). % false
?- default_observer(hover_action_2).
?- default_observer(hover_action_3). % false
?- default_observer(hover_action_4). % false
?- default_observer(hover_action_5). % false
?- default_observer(hover_action_6).
?- default_observer(hover_action_7). % false
...
?- check_terminal_observer(hover_action_6).
?- check_terminal_observer(hover_action_7). % false
...
?- check_terminal_constrained_observer(hover_action_7). % false
...
?- check_observer_and_constrained_subject(hover_action_4). % false
?- check_observer_and_constrained_subject(hover_action_5). % false
?- check_observer_and_constrained_subject(hover_action_6). % false
?- check_observer_and_constrained_subject(hover_action_7). % false
...
?- check_observer_and_singleton_subject(hover_action_7). % false
...
?- check_observer_and_terminal_subject(hover_action_7). % false
...
?- check_subject_constraint(hover_action_6).
?- check_subject_constraint(hover_action_7). % false
...
?- check_terminal_subject_constraint(hover_action_5). % false
?- check_terminal_subject_constraint(hover_action_6).
?- check_terminal_subject_constraint(hover_action_7). % false
