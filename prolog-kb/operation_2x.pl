...
?- default_singleton(hover_action_7). % false
...
?- constrained_subject(hover_action_5). % false
?- constrained_subject(hover_action_6). % false
?- constrained_subject(hover_action_7). % false
...
?- leading_subject(hover_action_7). % false
...
?- singleton_subject(hover_action_7).
...
?- terminal_observer(hover_action_2).
?- terminal_observer(hover_action_3). % false
?- terminal_observer(hover_action_4). % false
?- terminal_observer(hover_action_5). % false
?- terminal_observer(hover_action_6).
?- terminal_observer(hover_action_7). % false

?- print_heading('c12 terminal_constrained_observer').
?- terminal_constrained_observer(hover_action_1). % false
?- terminal_constrained_observer(hover_action_2).
?- terminal_constrained_observer(hover_action_3). % false
...
?- terminal_constrained_observer(hover_action_7). % false
...
?- observer_and_constrained_subject(hover_action_7). % false
...
?- observer_and_singleton_subject(hover_action_7). % false
...
?- observer_and_terminal_subject(hover_action_7). % false
...
?- subject_constraint(hover_action_7). % false
